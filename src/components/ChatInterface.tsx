    ...
    <div className="flex flex-col h-full w-full relative">
      ...
      {messages.length === 0 ? (
        <div
          ...
          className="flex-1 overflow-hidden p-4 md:p-6 scrollbar-thin"
        ...
        >
          <div className="w-full max-w-3xl mx-auto text-center">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 text-left font-geist ">
              ...
              <p className="mb-4">
                XeeAI is a general AI chatbot that is integrated with an Explainable AI (XAI) algorithm called{" "}
                <span>LIME</span>. You may use it just as any other regular chatbots, like asking{" "}
                <span>"What's Machine Learning?"</span> or <span>"Summarize this abstract". </span> Unlike other AI,
                XeeAI shows you how your input influenced its decisions. It was done through the following:
              </p>
              <ol className="list-decimal pl-5 space-y-2 mb-4">
                <li>It generates many variations of your input by masking or removing words and phrases.</li>
                <li>
                  For each variation, it generates a new output and compares it to the original response using semantic
                  similarity.
                </li>
                <li>
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mt-4">
                ...
                <p className="text-amber-700 text-sm">Like other chatbots, XeeAI can make mistakes on its output.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="sticky bottom-0 left-0 right-0 bg-white p-4 z-10">
        ...
        <p className="text-gray-600 text-center text-xs mt-5">
          Xee AI does make mistakes when identifying fake news. Please do some cross-referencing.
        </p>
      </div>
    </div>
  )
